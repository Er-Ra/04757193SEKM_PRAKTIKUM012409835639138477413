...
public:
    ...
    Logger(const std::string& filename, const unsigned int file_length_byte, const bool new_file_or_overwrite, const unsigned int log_size);
...
private:
    ...
    const std::string xml_header = "<?xml version=" + std::to_string(1.0) + " encoding=" + "UTF-8" + " ?>\n";
